...
public class Registrarsede extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese los datos de la sede que desea registrar");

        jLabel3.setText("Numero de sede");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().isEmpty() == true || jTextField2.getText().isEmpty() == true || jTextField3.getText().isEmpty() == true){
            ...
            sedeAux = new Sede (Integer.parseInt(jTextField1.getText()),jTextField2.getText(),jTextField3.getText());
            Login.admin.RegistrarSede(sedeAux);
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
        }
